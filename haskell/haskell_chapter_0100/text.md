...
[3,9..28] = [3,9,15,21,27]
```
Обратите внимание, что 28 не вошло в результирующий список, потому что по последовательности, следующим числом за 21 было бы 30, но оно не попадает в диапазон.
