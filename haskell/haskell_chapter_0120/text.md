...
Напишите функцию `area`, которая принимает название фигуры и длину ее грани. Варианты фигур: `"square"` (квадрат), `"triangle"` (*равнобедренный* прямоугольный треугольник), `"cube"` (куб). {.task_text}
...
Для фигур, не являющихся квадратом, равнобедренным прямоугольным треугольником или кубом, функция должна возвращать 0.
